...
const PrivacySection = ({
    ...
    <>
        <Switch
            ...
            onChange={value =>
                updatePreferencesKey('dht', value.target.checked)
            }
        />
        <Switch
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('pex', value.target.checked)
            }
        />
        <Switch
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('lsd', value.target.checked)
            }
        />
        <Select
            mt='md'
            ...
            value={
                BitTorrentEncryptionNameMapping[
                    preferences?.encryption as number
                ]
            }
        ...
        <Switch
            ...
            onChange={value =>
                updatePreferencesKey('anonymous_mode', value.target.checked)
            }
        />
    </>
);
