...
const QueueingSection = ({
    ...
    <>
        <Switch
            ...
            onChange={value =>
                updatePreferencesKey('queueing_enabled', value.target.checked)
            }
        />
        <NumberInput
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('max_active_downloads', value as number)
            }
        />
        <NumberInput
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('max_active_uploads', value as number)
            }
        />
        <NumberInput
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('max_active_torrents', value as number)
            }
        />
        <Switch
            mt='md'
