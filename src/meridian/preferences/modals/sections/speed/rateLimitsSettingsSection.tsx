...
const RateLimitsSettingsSection = ({
    preferences,
    ...
    <>
        <Switch
            ...
            onChange={value =>
                updatePreferencesKey('limit_utp_rate', value.target.checked)
            }
        />
        <Switch
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('limit_tcp_overhead', value.target.checked)
            }
        />
        <Switch
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('limit_lan_peers', value.target.checked)
            }
        />
    </>
);
