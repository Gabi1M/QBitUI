...
const ProxyServerSection = ({ preferences, updatePreferencesKey }: SectionProps) => (
    <>
        ...
        <TextInput
            ...
            onChange={(value) => updatePreferencesKey('proxy_ip', value.target.value)}
        />
        <NumberInput
            mt='md'
            label={t`Port`}
            value={preferences?.proxy_port || 0}
            onChange={(value) => updatePreferencesKey('proxy_port', value as number)}
        />
        <Switch
            mt='md'
            ...
            onChange={(value) =>
                updatePreferencesKey('proxy_peer_connections', value.target.checked)
            }
        />
        <Switch
            mt='md'
            ...
            onChange={(value) => updatePreferencesKey('proxy_torrents_only', value.target.checked)}
        />
        <Switch
            mt='md'
            label={t`Authentication`}
            checked={preferences?.proxy_auth_enabled || false}
            onChange={(value) => updatePreferencesKey('proxy_auth_enabled', value.target.checked)}
        />
        <TextInput
            mt='md'
            label={t`Username`}
            ...
            onChange={(value) => updatePreferencesKey('proxy_username', value.target.value)}
        />
        <PasswordInput
