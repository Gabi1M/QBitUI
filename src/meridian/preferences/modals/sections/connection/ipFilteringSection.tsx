...
const IpFilteringSection = ({
    ...
    <>
        <TextInput
            ...
            onChange={value =>
                updatePreferencesKey('ip_filter_path', value.target.value)
            }
        />
        <Switch
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('ip_filter_trackers', value.target.checked)
            }
        />
        <Textarea
            mt='md'
            ...
            onChange={value =>
                updatePreferencesKey('banned_IPs', value.target.value)
            }
        />
    </>
);
