...
const SecuritySection = ({
    ...
    <>
        <Switch
            ...
            checked={
                preferences?.web_ui_clickjacking_protection_enabled || false
            }
            onChange={value =>
                updatePreferencesKey(
        ...
        <Switch
            ...
            checked={
                preferences?.web_ui_host_header_validation_enabled || false
            }
            onChange={value =>
                updatePreferencesKey(
        ...
        <Textarea
            ...
            onChange={value =>
                updatePreferencesKey('web_ui_domain_list', value.target.value)
            }
        />
    </>
);
