...
const AuthenticationSection = ({ preferences, updatePreferencesKey }: SectionProps) => (
    <Accordion.Panel>
        <TextInput
            ...
            onChange={(value) => updatePreferencesKey('web_ui_username', value.target.value)}
        />
        <PasswordInput
            autoComplete='new-password'
            mt='md'
            ...
            onChange={(value) => updatePreferencesKey('web_ui_password', value.target.value)}
        />
        <Switch
            mt='md'
            ...
            onChange={(value) =>
                updatePreferencesKey('bypass_auth_subnet_whitelist_enabled', value.target.checked)
            }
        />
        <Textarea
            mt='md'
            ...
            onChange={(value) =>
                updatePreferencesKey('bypass_auth_subnet_whitelist', value.target.value)
            }
        />
        <NumberInput
            mt='md'
            ...
            onChange={(value) =>
                updatePreferencesKey('web_ui_max_auth_fail_count', value as number)
            }
        />
        <NumberInput
            mt='md'
            ...
            onChange={(value) => updatePreferencesKey('web_ui_ban_duration', value as number)}
        />
        <NumberInput
            mt='md'
