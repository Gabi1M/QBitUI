    ...
    return (
        <>
            <Switch
                ...
                onChange={(value) =>
                    updatePreferencesKey('alternative_webui_enabled', value.target.checked)
                }
            />
            <TextInput
                mt='md'
                ...
                onChange={(value) =>
                    updatePreferencesKey('alternative_webui_path', value.target.value)
                }
            />
            <TextInput
                mt='md'
                ...
                onChange={(value) => updatePreferencesKey('web_ui_address', value.target.value)}
            />
            <NumberInput
                mt='md'
                label={t`Port`}
                value={preferences?.web_ui_port || 0}
                onChange={(value) => updatePreferencesKey('web_ui_port', value as number)}
            />
            <Switch
                mt='md'
                label={t`Use UPnP / NAT-PMP to forward the port from my router`}
                checked={preferences?.web_ui_upnp || false}
                onChange={(value) => updatePreferencesKey('web_ui_upnp', value.target.checked)}
            />
            <Switch
                mt='md'
                label={t`Use HTTPS instead of HTTP`}
                checked={preferences?.use_https || false}
                onChange={(value) => updatePreferencesKey('use_https', value.target.checked)}
            />
            <TextInput
                mt='md'
                ...
                onChange={(value) =>
                    updatePreferencesKey('web_ui_https_cert_path', value.target.value)
                }
            />
            <TextInput
                mt='md'
                ...
                onChange={(value) =>
                    updatePreferencesKey('web_ui_https_key_path', value.target.value)
                }
            />
            <Switch
                mt='md'
            ...
            <Textarea
                ...
                onChange={(value) =>
                    updatePreferencesKey('web_ui_custom_http_headers', value.target.value)
                }
            />
